\chapter{\textbf{\textit{Virtual Microfluidics}}: a hydrogel-based system for simple and robust DNA digital quantification using amplification}
...
% \label{fig:dMDA_clusterRadiusChange}
% \end{figure}
